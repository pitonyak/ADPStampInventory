...
void LogRoutingInfoDialog::initialize()
{
  ...
  // ?? TODO: ui->locSyntax->setToolTip(tr("Set location regular expression pattern syntax."));
  ...
  // ?? TODO: ui->locSyntax->setToolTip(tr("Set unformatted message regular expression pattern syntax."));
